            ...
            <div class="meta-item meta-copyright">
                <div class="meta-copyright-info">
                    ...
                    <div class="info-text">
                        ...
                        <p>Theme RemiDark by <a href="https://remiki.ren/" target="_blank">Remi</a></p>
                        <p>Based on <a href="https://github.com/chakhsu/pinghsu" target="blank">Pinghsu</a> by <a href="https://www.linpx.com/" target="_blank">Chakhsu</a></p>
                        <?php if ($this->options->MoeICPRecordNumber): ?>
                        <p><a href="https://icp.gov.moe/?keyword=<?php $this->options->MoeICPRecordNumber(); ?>" target="_blank">萌ICP备<?php $this->options->MoeICPRecordNumber(); ?>号</a></p>
                        <?php endif; ?>
                        <?php if ($this->options->ICPRecordNumber): ?>
                        <p><a href="https://beian.miit.gov.cn/" target="blank" ><?php $this->options->ICPRecordNumber(); ?></a></p>
                        <?php endif; ?>
                        <p>&copy; 2023-<?php echo date('Y'); ?> <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a></p>
                    </div>
                </div>
            </div>
