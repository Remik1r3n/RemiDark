...
<article class="main-content <?php if ($this->options->postshowthumb == 'able'): ?>post-page<?php else: ?>page-page<?php endif; ?>" itemscope itemtype="http://schema.org/Article">
	...
	<div id="post-content" class="post-content" itemprop="articleBody">
		...
		<p class="post-info">
			本站文章除注明转载/出处外，</br>均为本站原创或翻译，</br>并在 <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="external nofollow">知识共享署名 4.0</a> 国际许可协议下提供。</br>若有相关的疑问或质疑，请留下评论，或<a href="<?php $this->options->contactPage(); ?>">联系我</a>。
		</p>
	</div>
</article>
